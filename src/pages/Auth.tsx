...
import { Zap, Sparkles, Globe, MessageSquare, Phone, Loader2 } from "lucide-react";
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      if (isLogin) {
        ...
        // Registration: require phone number
        ...
        if (otpError) {
          console.warn("Phone OTP not configured:", otpError.message);
          toast({
            title: "Account created!",
            description: "Check your email to confirm your account. Phone verification will be available soon.",
          });
        } else {
          setShowOtp(true);
          toast({
        ...
        <Card className="w-full max-w-md shadow-elevated border-border">
          <CardHeader className="text-center space-y-2 pb-2">
            ...
            <p className="text-sm text-muted-foreground">
              Enter the 6-digit code sent to {phone.startsWith("+") ? phone : `+${phone}`}
            </p>
          </CardHeader>
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              {!isLogin && (
                <div className="space-y-2">
                  ...
                  <p className="text-[10px] text-muted-foreground">Include country code (e.g. +91, +1)</p>
                </div>
              )}
